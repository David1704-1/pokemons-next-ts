...
const Pokemon: NextPage<Props> = ({pokemon})=>{
    const pokemon_name = pokemon.name.charAt(0).toUpperCase() + pokemon.name.substring(1,pokemon.name.length)    
    return (
        <>
        ...
        <Card
            ...
            />}
        >
       <h1 style={h1_font_style}>{pokemon.name.charAt(0).toUpperCase() + pokemon.name.substring(1,pokemon.name.length)}</h1>
       <hr style={hr_style}/>
       <p style={p_style}>Moves: {
